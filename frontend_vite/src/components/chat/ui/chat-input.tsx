...
import {CommandPalette} from "@/components/chat/features/command-palette.tsx"
import {COMMANDS, type Command} from "@/components/chat/features/commands.ts"
...
export function ChatInput({onSendMessage, disabled}: ChatInputProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="relative">
            ...
            <div
                className="relative flex items-center rounded-3xl md:rounded-4xl border border-input bg-chat-input-bg shadow-sm pl-4 md:pl-6 pr-12 md:pr-14"
            >
                <textarea
                    ref={textareaRef}
                    value={input}

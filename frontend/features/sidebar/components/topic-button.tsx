            ...
            <div className="relative z-10 flex items-center gap-3 md:gap-4 w-full">
                <div
                    className={cn(
                        ...
                        !disabled && "group-hover:bg-topic-button-accent/20 group-active:bg-topic-button-accent/20 group-hover:scale-110 group-hover:rotate-6 group-active:scale-110 group-active:rotate-6"
                    )}>

...
export function NewChatButton() {
    ...
    return (
        <div
            id="tour-clear-chat"
            className={cn(
                "px-4 md:px-4 xl:px-5 pt-2 md:pt-3 xl:pt-4 transition-all duration-300",
        ...
        >
            <Button
                ...
                variant="outline"
                className={cn(
                    "group relative w-full justify-start gap-2 md:gap-3 rounded-xl py-2.5 md:py-3 xl:py-4 overflow-hidden transition-all duration-300",

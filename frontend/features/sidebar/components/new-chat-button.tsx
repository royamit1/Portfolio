...
export function NewChatButton() {
    ...
    return (
        <div
            id="tour-clear-chat"
            className={cn(
                "px-4 md:px-6 pt-6 md:pt-6 transition-all duration-300",
        ...
        >
            <Button
                ...
                variant="outline"
                className={cn(
                    "group relative w-full justify-start gap-3 rounded-xl py-4 md:py-5 overflow-hidden transition-all duration-300",

...
export function ProfileHeader() {
    return (
        <div className="relative z-10 flex flex-col pt-8 pb-2 px-4 md:px-5">
            {/* Role Label */}
            <div className="mb-2">
                <span className="inline-block text-[10px] font-bold tracking-[0.2em] uppercase text-indigo-400">

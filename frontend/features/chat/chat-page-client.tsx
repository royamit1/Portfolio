...
import {ChatLayout} from '@/features/chat/index';
import type {ChatWindowRef} from '@/features/chat/index';
...
export default function ChatPageClient() {
    ...
    const handleTopicSelect = useCallback(async (topic: Topic) => {
        ...
        chatWindowRef.current?.scrollToBottom('auto');
        ...
        setIsTyping(false);
    }, [chatWindowRef, setIsSidebarOpen, setIsTyping, setMessages, setShowBanner]);
    ...
    const handleSendMessage = useCallback(async (content: string) => {
        ...
        // Default response logic (mocking API call)
        ...
        setIsTyping(false);
    }, [setIsContactDialogOpen, setIsTyping, setMessages, setShowBanner]);

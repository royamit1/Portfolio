    ...
    return (
        <div className="relative z-10 px-5">
            <Button
                onClick={onClearChat}
                variant="outline"
                className="group w-full justify-start gap-4 rounded-xl py-5 relative overflow-hidden transition-all duration-300 bg-sidebar/50 backdrop-blur-sm border-sidebar-border/40 hover:bg-sidebar-accent/20 hover:shadow-lg hover:scale-[1.02] active:bg-sidebar-accent/30 active:scale-[0.98]"
            >
                <div

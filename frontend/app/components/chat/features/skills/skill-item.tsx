...
const SkillItemComponent: React.FC<SkillItemProps> = ({skill}) => (
    <motion.div
        ...
        className="relative overflow-hidden bg-gray-800/30 border border-border rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 group"
    >
        <div

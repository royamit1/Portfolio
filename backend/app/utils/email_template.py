...
def create_contact_email_html(message):
    ...
    <body style="margin: 0; padding: 0; background-color: #f4f4f5;
      ...
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
        style="padding: 24px 0; background-color: #f4f4f5;">
        <tr>
          <td align="center">
            ...
            <table width="600" cellpadding="0" cellspacing="0" role="presentation"
              ...
              <!-- Header Bar -->
              <tr>
                <td style="background-color: #111827; padding: 20px 32px; text-align: left;">
              ...
              <tr>
                <td style="padding: 28px 32px;">
                  ...
                  <!-- Message -->
                  <div style="padding: 16px; background-color: #f9fafb; border: 1px solid #e5e7eb;
                      border-radius: 6px; font-size: 14px; color: #374151; line-height: 1.6;">
              ...
              <tr>
                <td style="background-color: #f3f4f6; padding: 16px 32px; text-align: center;
                  ...
                  © {datetime.now().year} Portfolio Contact System — This email was automatically generated.
                </td>
              </tr>

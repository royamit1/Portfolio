---
title: "Building an AI-Powered Portfolio: A Developer's Journey"
published: false
description: "Building an AI portfolio from scratch using Next.js, FastAPI, and RAG. A deep dive into the architectural decisions, technical challenges, and lessons learned along the way."
tags: nextjs, ai, portfolio, python, langchain
cover_image: https://raw.githubusercontent.com/royamit1/portfolio/main/frontend/public/og-image.png
canonical_url:
series:
---
